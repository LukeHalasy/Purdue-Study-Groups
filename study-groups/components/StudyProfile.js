...
import { Text, View, StyleSheet, NavigatorIOSm, ActivityIndicator
 } from 'react-native';
...
var avatarList = [
  ...
  },
  {
    ...
    avatar_url: 'https://cdn.pixabay.com/photo/2015/02/28/09/32/beautiful-653317_1280.jpg'
  },{
    avatar_url: 'https://cdn.pixabay.com/photo/2016/11/08/16/03/manager-1808728_1280.jpg'
  },{
    avatar_url: 'https://cdn.pixabay.com/photo/2015/10/18/16/40/taxation-994707_1280.jpg'
  },{
    avatar_url: 'https://cdn.pixabay.com/photo/2016/07/27/08/00/female-model-1544783_1280.jpg'
  },{
    avatar_url: 'https://cdn.pixabay.com/photo/2016/07/27/07/57/male-1544775_1280.jpg'
  }
]
            ...
            <List containerStyle={styles.member}>
            {
              this.state.dataSource.map((l) => (
                <ListItem
                  ...
                  avatar={{uri:avatarList[Math.floor(Math.random() * 7)].avatar_url}}
                  key={l.name}
                  title={l.name}
                />
              ))}
